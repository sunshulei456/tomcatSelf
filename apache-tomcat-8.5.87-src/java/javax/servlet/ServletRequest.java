...
/**
 * <p>
 *    Servlet 容器在接收到客户端的 HTTP 请求后，会将请求信息封装成一个 ServletRequest 对象，并将其作为参数传递给对应的 Servlet 的 service() 方法。
 *    开发者可以通过 ServletRequest 接口提供的方法，获取请求信息并进行相应的处理。
 * </p>
...
public interface ServletRequest {
     ...
     * <p>
     *     请求方所在的地区。
     *     基于accept Language标头，返回客户端将接受内容的首选区域设置。如果客户端请求没有提供Accept-Language标头，则此方法将返回服务器的默认区域设置。
     * </p>
