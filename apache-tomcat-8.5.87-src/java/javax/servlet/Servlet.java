 ...
 *        service()：处理客户端请求
 *        destroy()：方法执行完成后销毁
 *        getServletConfig()：调用init()方法时传递给Servlet对象的ServletConfig对象
 *        getServletInfo()：返回一个String类型的字符串，其中包括了关于Servlet的信息，例如，作者、版本和版权。
 *
 *
 *     }
 *
...
public interface Servlet {
     ...
     *
     * <p>
     *     servlet 第一次被请求时， servlet 容器调用该方法初始化一个 servlet 对象
     *     但是该方法在后续过程中不会被调用
     * </p>
